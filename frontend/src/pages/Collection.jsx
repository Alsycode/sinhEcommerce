...
{/* product sort */}
<select className='border-2 text-gray-300 text-sm px-2'>
...
{
filterProducts.map((item,index)=>(<ProductItem key={index} id={item.id} price={item.price} name={item.name} image={item.image}/>))
}
</div>
</div>
    </div>

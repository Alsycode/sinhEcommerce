...
<div onClick={()=>setMethod("stripe")} className='flex items-center px-3 p-2 border cursor-pointer'>
...
<div onClick={()=>setMethod("razorpay")} className='flex items-center px-3 p-2 border cursor-pointer'>
...
<div onClick={()=>setMethod("cod")} className='flex items-center px-3 p-2 border cursor-pointer'>

...
<img src={assets.search_icon} className="w-5 cursor-ponter" alt='searchIcon'/>
...
<p className='text-[8px] right-[-5px] bottom-[-5px] absolute bg-black  w-4 text-center text-white rounded-full aspect-square leading-4'>2</p>
     </Link>
